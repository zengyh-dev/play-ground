...
vec4 pack(float depth) {
    ...
    const vec4 bitShift = vec4(1.0f, 256.0f, 256.0f * 256.0f, 256.0f * 256.0f * 256.0f);
    const vec4 bitMask = vec4(1.0f / 256.0f, 1.0f / 256.0f, 1.0f / 256.0f, 0.0f);
...
void main() {
    ...
    // are odd.
      ...
      // In the case where the width and height are both odd, need to include the
        ...
        FragColor = vec4(vec3(minDepth), 1.0f);
    }
}