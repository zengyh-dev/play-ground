...
export class Texture {
    ...
    constructor() {}
    CreateImageTexture(gl: WebGL2RenderingContextExtend, image: HTMLImageElement) {
    ...
    CreateConstantTexture(gl: WebGL2RenderingContextExtend, buffer: number[], gamma?: boolean) {
        this.texture = gl.createTexture();
        gl.bindTexture(gl.TEXTURE_2D, this.texture);
    ...
    CreateMipmap(gl: WebGL2RenderingContextExtend, width: number, height: number) {
        gl.bindTexture(gl.TEXTURE_2D, this.texture);
