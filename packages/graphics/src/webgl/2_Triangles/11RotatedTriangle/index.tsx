...
import FSHADER_SOURCE from "./rotate.frag";
import VSHADER_SOURCE from "./rotate.vert";
...
function RotatedTriangle() {
    ...
    const draw = (gl: WebGLRenderingContextExtend) => {
        ...
        const u_CosB = gl.getUniformLocation(gl.program as WebGLProgram, "u_CosB") as number | null;
        ...
        const u_SinB = gl.getUniformLocation(gl.program as WebGLProgram, "u_SinB") as number | null;
        if (!u_SinB || u_SinB < 0) {
