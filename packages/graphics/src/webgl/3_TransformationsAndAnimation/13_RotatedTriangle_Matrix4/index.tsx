...
function RotatedTriangleMatrix4() {
    ...
    const draw = (gl: WebGLRenderingContextExtend) => {
        ...
        // 将旋转矩阵传输给顶点
        const u_xformMatrix = gl.getUniformLocation(gl.program as WebGLProgram, "u_xformMatrix") as number | null;
        if (!u_xformMatrix || u_xformMatrix < 0) {
...
export default RotatedTriangleMatrix4;
