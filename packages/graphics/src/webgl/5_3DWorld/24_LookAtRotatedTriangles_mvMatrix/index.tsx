...
function LookAtRotatedTriangles_mvMatrix() {
    ...
    const draw = (gl: WebGLRenderingContextExtend) => {
        ...
        const u_ModelViewMatrix = gl.getUniformLocation(gl.program as WebGLProgram, "u_ModelViewMatrix");
        //两个矩阵相乘
        //var modelViewMatrix = viewMatrix.multiply(modelMatrix);
        const modelViewMatrix = new Mat4();
        modelViewMatrix.setLookAt(0.2, 0.25, 0.25, 0, 0, 0, 0, 1, 0).rotate(-50, 0, 0, -1);
...
export default LookAtRotatedTriangles_mvMatrix;
